...
const staffDelete = function (name, id) {
    ...
    <el-skeleton :loading="loading" animated>
      ...
      <template #default>
        <el-row :gutter="10">
          <el-col
            :span="4"
            v-for="staff in staffs.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
            :key="staff"
          >
            <el-card shadow="hover" style="padding: 0; margin-bottom: 20px; height: 280px">
              ...
              >
                ...
                <div class="bottoms" style="display: flex; justify-content: center">
                  <el-button size="small" type="info" @click="updateForm(staff.staffId)"
                    >修改
                  </el-button>
                  <el-button
                    size="small"
                    type="danger"
                    @click="staffDelete(staff.name, staff.staffId)"
                    >删除
                  </el-button>
                </div>
              </div>
        ...
        <el-row align="middle">
          <el-col :span="12">
            ...
            <el-image
              :src="staff.imageUrl"
              fit="cover"
              style="height: 350px; width: 300px; margin: 5px 0 20px 65px"
            />
          </el-col>
          <el-col :span="12">
            <!-- 影人Id查看 -->
        ...
        <el-row>
          <el-col>
            ...
            <el-form-item label="图片URL">
              <el-input
                v-model="staff.imageUrl"
                @change="formStatus = true"
                placeholder="请输入影人海报URL"
              >
